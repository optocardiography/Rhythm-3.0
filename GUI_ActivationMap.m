...
interpolationcheckbox = uicontrol('Parent',activationMapGroup,'Style','checkbox',...
                        'String','Interpolation','FontSize',fontSize,...
                        'Units','normalized','Position',[0 0.08 1 .05],'HorizontalAlignment','left',...
                        'Visible','on');
...
create_amap_button  = uicontrol('Parent',activationMapGroup,...
                                       ...
                                       'String','Regional map',...
                                       'Units','normalized',...
                                       'Position',[pos_left, pos_bottom+0.1, element_width, element_height],...
...
export_button = uicontrol('Parent',activationMapGroup,'Style','pushbutton',...
                        'Units','normalized',...
                        'Position',[pos_left, pos_bottom+0.1, element_width, 2*element_height]...
...
%% Export picture from the screen
    function export_button_callback(~,~)
        ...
        isInterpolation = get(interpolationcheckbox,'Value');
        if isInterpolation
